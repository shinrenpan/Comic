...
//  GBig.swift
//
//  Created by Shinren Pan on 2024/6/10.
//
...
/// 簡繁轉換.
///
/// 參考: // https://github.com/zhishidapang/GBig
final class GBig {
    static let big5 =
    ...
    static func simplify(_ ch: String) -> String {
        String(ch.map { c in
    ...
    static func traditionalize(_ ch: String) -> String {
        String(ch.map { c in
