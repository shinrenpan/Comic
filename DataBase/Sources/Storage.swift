...
public actor Storage: ModelActor {
    static public let shared = Storage()
    nonisolated public let modelContainer: ModelContainer
    nonisolated public let modelExecutor: any ModelExecutor
    
    private init() {
        let modelContainer = try! ModelContainer(for: Comic.self, Detail.self, Episode.self)
...
public extension Storage {
    ...
    func getEpisodes(comicId: String) -> [Episode] {
    ...
    func updateEpisodes(id: String, episodes: [Episode]) {
